                ...
                <aside className={`h-screen w-[20%] lg:w-[14%] border-r-2 border-[#A3BAC2] fixed left-0 top-0 bg-white ${isOpen ? 'block' : 'hidden'} md:block min-w-50`}>
                    <div className="mt-24 m-2 flex flex-col gap-3 ">
                        <Link to={'/student/dashboard'}>
                            <div className={`hover:bg-[#E0E8EB] hover:border-l-8 hover:font-bold h-full w-full transition-all text-[#3f454c] font-semibold py-2 ${location.pathname == '/student/dashboard' ? 'border-l-8 ' : 'none'}`}>
