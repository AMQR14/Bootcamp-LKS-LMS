                ...
                <main className="flex ">
                    <div className="m-8 md:mx-20  w-full ">
                        ...
                        <div className="min-h-screen my-5">
                            ...
                            {course.map((course)=>(
                                    <Link to={`/student/dashboard/course/${course.id}`}>
                                        <div className="group/card w-full h-60 shadow-md rounded-md bg-[#9aa8b7] overflow-hidden" key={course.id}>
                                        <div className={`justify-end flex flex-row w-full absolute fit -translate-x-3 -translate-y-3  ${course.exam == null ? 'hidden' : 'block'}`}>
                                                ...
                                                <div className="h-20 max-h-100 group-hover/card:h-32  w-full bg-white transition-all">
                                                    <div className="m-3">
                                                        ...
                                                        <div className="hidden group-hover/card:block transition-all">
                                                            <div className='text-[#5a767f] font-semibold text-md bg-[#e0e8eb] rounded-md m-auto p-2 border border-[#b2cbd3] truncate'>{course.exam == null ? 'There is no exam' : `Exam |  ${course.exam?.name}`}</div>
                                                        </div>
                                                    </div> 
                                                </div>
                                            </div>
