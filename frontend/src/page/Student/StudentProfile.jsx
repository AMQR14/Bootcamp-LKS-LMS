...
export default function StudentProfile(){
    ...
    useEffect(()=>{
        async function fetchUser() {
            ...
            try{
                ...
                if(res.data.user.student?.profile_picture){
                    localStorage.setItem('profile_picture', `${res.data.user.student.pfp}`)
                }
                
                setUserid(res.data.user.student.id)
                setForm(res.data.user.student)
                console.log(res.data.user.student.pfp)

                if(res.data.user.student.profile_picture){
                    setPreview(`${res.data.user.student.pfp}`)
                }
            }finally{
                setLoading(false)
            }
    ...
    async function handleSubmit(e) {
        ...
        try{
            await api.post(`/students/${userid}`, data, {
            ...
            <main className="flex">
                <div className="m-8 md:mx-20 w-full">
                    ...
                    <div className='my-6 text-[#3f454c] flex flex-col lg:flex-row gap-x-8 gap-y-8'>
                        <form className='p-4 rounded-xl shadow-md h-full w-full lg:w-190' onSubmit={handleSubmit}>
                            <div className='flex flex-col justify-center gap-5'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input 
                                        type="text" 
                                        value={loading ? 'Loading...' : form.name} 
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input 
                                        type="text" 
                                        value={loading ? 'Loading...' : form.email} 
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input 
                                        type="text" 
                                        value={loading ? 'Loading...' : form.nis} 
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input 
                                        type="text" 
                                        value={loading ? 'Loading...' : form.nisn} 
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input 
                                        type="text" 
                                        value={loading ? 'Loading...' : form.nik} 
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    <input 
                                        type="date" 
                                        value={loading ? '' : form.date_of_birth} 
                                        className='p-2 w-full border-2 border-[#E0E8EB] rounded-md hover:border-[#60848f] transition-all focus:outline-none focus:border-[#60848f]' 
