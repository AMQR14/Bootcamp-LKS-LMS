        ...
        <DashboardLayout>
            <main className="flex">
                    <div className="m-8 md:mx-20 w-full">
                        <h1 className='font-bold text-2xl text-[#3f454c]'>Detail Student</h1>
                        <div>
                            <div className='flex justify-end'>
                                <Link to={'/admin/dashboard/students'} className='flex justify-center items-center w-14 h-10 bg-[#60848f] hover:bg-[#76a0ad] transition-all text-white font-semibold rounded-md '><MoveLeft className='size-7 stroke-2'/></Link>
                            </div>
                        </div>
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 w-full  mt-6  rounded-xl p-8 text-[#3f454c] border-[#A3BAC2] border-2'>
                                ...
                                <div className='flex gap-1 bg-gray-100 p-3 px-5 rounded-md flex-col'>
                                    <label className='font-semibold text-sm'>NIS :</label>
                                    <p>{loading ? 'Loading...' : datas.nis}</p>
                                </div>

                                <div className='flex gap-1 bg-gray-100 p-3 px-5 rounded-md flex-col'>
                                    <label className='font-semibold text-sm'>NISN :</label>
                                    <p>{loading ? 'Loading...' : datas.nisn}</p>
                                </div>
