                            ...
                            <table className='w-full text-[#3f454c]'>
                                <thead className=''>
                                    <tr >
                                        ...
                                        <th className='border-b-2 border-r-2 p-2 border-[#A3BAC2]'>Date</th>
                                        <th className='border-b-2 border-r-2 p-2 border-[#A3BAC2]'>Enrolled</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className='border-b p-2 px-6 flex justify-center items-center gap-5 border-[#A3BAC2]'>
                                            <Link to={'/editcourses'} className='flex justify-center items-center w-24 h-8 bg-[#60848f] hover:bg-[#76a0ad] transition-all text-white font-semibold rounded-md'>Edit</Link>
