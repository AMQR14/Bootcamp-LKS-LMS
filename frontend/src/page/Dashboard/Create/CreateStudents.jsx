                            ...
                            <form action="" className='p-4 rounded-xl shadow-md h-130 w-full'>
                                <div className='flex flex-col justify-center gap-5'>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <input type="text" placeholder='Enter email address' className='p-2 w-full border-2 border-[#E0E8EB] rounded-md hover:border-[#60848f] transition-all focus:outline-none focus:border-[#60848f]'/>
                                    </div>
