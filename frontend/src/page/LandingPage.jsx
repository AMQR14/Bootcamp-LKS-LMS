...
export default function LandingPage(){
    ...
    return (
        <HomeLayout>
            <div className='h-130 w-full bg-[#A3BAC2] flex justify-center items-center'>
                    <div className='flex flex-col gap-3 m-10 sm:m-0 max-w-130'>
                ...
                <div>
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 m-10 mb-24 gap-10 md:gap-10'>
                        <div className=' w-full h-100 border-2 border-[#E0E8EB] hover:border-[#60848f] transition-all rounded-xl overflow-auto'>
                            <div className='m-6'>
                    ...
                    <div className='border-y-30 border-[#ccd7db]'>
                        <div className='border-y-40 border-[#b9cbd1]'>
                            <video src={Video} autoPlay loop className='mx-auto w-full border-y-50 border-[#a3bac2]'/> {/*bisa add controls*/}
